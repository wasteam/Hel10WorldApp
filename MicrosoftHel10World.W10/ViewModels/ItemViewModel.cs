...
namespace MicrosoftHel10World.ViewModels
{
    public class ItemViewModel : ObservableBase, INavigable, ISyncItem<ItemViewModel>
    {
        ...
        private string _extendedProperty1;
        private string _extendedProperty2;
        private string _extendedProperty3;
        ...
        {
            get { return _extendedProperty1; }
            set { SetProperty(ref _extendedProperty1, value); }
        }

        public string ExtendedProperty2
        {
            get { return _extendedProperty2; }
            set { SetProperty(ref _extendedProperty2, value); }
        }

        public string ExtendedProperty3
        {
            get { return _extendedProperty3; }
            set { SetProperty(ref _extendedProperty3, value); }
        }
